...
const SignUpScreen = () => {
    ...
    return (
        ...
        <LinearGradient
            ...
            colors={isDark ? ["#182240", "#115A67", "#AA3E14"]
                ...
                <View className='w-3/4 self-center'>
                    ...
                    <View className="mb-6">
                        ...
                        <View className="flex-row items-center justify-start w-full my-4 pr-2">
                            <TouchableOpacity
                                ...
                                className={`w-5 h-5 rounded border mr-3 justify-center items-center ${isTermsAccepted
                    ...
                    <View className='items-center mb-4 mt-2'>
                        ...
                        <Text className='dark:text-background-light mt-6'>
                            ...
                            <Text className='font-semibold dark:text-background-light' onPress={() => router.push('/LoginScreen')}>
                                Log In
                            </Text>
                        </Text>
                    </View>
