        ...
        <View className="w-3/4 self-center">
          ...
          <View className="mb-6">
            ...
            <View className="flex-row items-center justify-start w-full my-4 pr-2">
              ...
              >
                {isTermsAccepted && (
                  <Text className="text-background-light dark:text-background-dark font-bold text-xs">
                    ✓
                  </Text>
                )}
              </TouchableOpacity>
        ...
        >
          <View className="flex-1 bg-black/60 justify-end">
            <SafeAreaView className="bg-white dark:bg-slate-900 h-[80%] rounded-t-3xl p-6 shadow-2xl">
              ...
              >
                <Text className="text-xs text-slate-400 mb-3 font-mono">
                  {TERMS_AND_SERVICES_TEXT.version}
                </Text>
